...
/// 
/// educationai provides developers with professional-grade tools and patterns
/// for building exceptional iOS applications.
public final class educationai {
    ...
    public func configure() {
        ...
        print("✅ educationai configured successfully")
    }
    
    /// Reset the framework to initial state
    public func reset() {
        isConfigured = false
        print("🔄 educationai reset to initial state")
    }
