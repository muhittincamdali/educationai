...
/// Basic example demonstrating the core functionality of educationai
@main
struct BasicExample {
    static func main() {
        print("🚀 educationai Basic Example")
    ...
    static func demonstrateBasicFeatures(_ framework: educationai) {
